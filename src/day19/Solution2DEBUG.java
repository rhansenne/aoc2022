...
public class Solution2DEBUG {
	...
	public static void main(String[] args) throws Exception {
		...
		for (Blueprint bp: blueprints) {
			...
			System.out.println("blueprint "+bp.id+" -> geodes: "+maxGeode+" -> quality: "+bp.id*maxGeode);
			result *= maxGeode;
		}
...
//		maxGeode=0;
//		geodesAtMinutesLeft = new int[minutes+1];
//		tryAllBuildCombinations(blueprints.get(0), minutes, new int[] {1,0,0,0}, new int[] {0,0,0,0});			
//		long t2 = System.currentTimeMillis();
//		System.out.println("DURATION: "+(t2-t1)); // 5100-5300 -> 4200 -> 2965 -> 881
//		System.out.println(maxGeode);
	...
	static void tryAllBuildCombinations(Blueprint bp, int minutesLeft, int[] robots, int[] material) {
		...
		// stop suboptimal scenarios
//		if (robots[Material.geode.index]<geodesAtMinutesLeft[minutesLeft]) {
//				return;
//		} else {
